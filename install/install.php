...
<div id="text_step2" style="display:none;">
    ...
    <li>PHP extension "gmp" is loaded&nbsp;<span id="res2_check7"></span></li>
...
<div id="text_step4" style="display:none;">
    ...
    <div class="line_entry">
    <label for="encrypt_key" class="label_block_big">Encryption key (SaltKey): <img src="../includes/images/information-white.png" alt="" title="For security reasons, salt key must be more than 15 characters and less than 32, should contains upper and lower case letters, special characters and numbers, and SHALL NOT CONTAINS single quotes!!!" />
    </label>
    ...
    <div class="line_entry">
    <label for="admin_pwd" class="label_block_big">Administrator password :</label><input type="text" id="admin_pwd" value="" style="width:250px;" />&nbsp;<span id="res4_check10"></span>
    </div>
...
<div id="text_step7" style="display:none;">
    ...
    You can log as an Administrator by using login <b>admin</b> .<br />
