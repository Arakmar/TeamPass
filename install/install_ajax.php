    ...
    switch ($_POST['type']) {
        ...
        case "step4":
            ...
            mysqli_query($dbTmp,
                ...
                ('admin', 'email_security', '".$_SESSION['smtp_security']."'),
                ('admin', 'email_server_url', '".$_SESSION['url_path']."'),
            ...
            */
            ...
            mysqli_query($dbTmp,
                "INSERT INTO `".$_SESSION['tbl_prefix']."languages` (`name`, `label`, `code`, `flag`) VALUES
