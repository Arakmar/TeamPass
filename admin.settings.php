...
echo '
                    <tr style="margin-bottom:3px">
                        ...
                        <td>
                            ...
                            <option value="ssl"', $_SESSION['settings']['email_security'] == "ssl" ? ' selected="selected"':"", '>SSL</option>
                            <option value="tls"', $_SESSION['settings']['email_security'] == "tls" ? ' selected="selected"':"", '>TLS</option>
                        </select>
                        </td>
                    </tr>';
// SMTP from
